...
const Settings: React.FC = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    title: 'Sales Manager',
    department: 'Sales',
    bio: 'Experienced sales professional with 5+ years in CRM and client relationship management.'
  });
            ...
            <nav className="p-4 space-y-1">
              {tabs.map((tab) => {
                ...
                return (
                  ...
                  >
                    <Icon className={`w-5 h-5 ${activeTab === tab.id ? 'text-blue-700' : 'text-gray-500'}`} />
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div>
                      ...
                      <button className="mt-2 px-4 py-2 border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                        Change Photo
                      </button>
                    </div>
                  </div>
                      ...
                      {Object.entries({
                        ...
                        <div key={key} className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm text-gray-600">Receive notifications via {label.toLowerCase()}</p>
                          </div>
                    ...
                    <div className="space-y-4">
                      {Object.entries({
                        ...
                        <div key={key} className="flex items-center justify-between">
                          <div>
                            <p className="font-medium text-gray-900">{label}</p>
                            <p className="text-sm text-gray-600">Get notified about {label.toLowerCase()}</p>
                          </div>
                          <label className="relative inline-flex items-center cursor-pointer">
                            <input
                              type="checkbox"
            ...
            {activeTab === 'security' && (
              <div className="p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 mb-4">Security Options</h3>
                    <div className="space-y-4">
